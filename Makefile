...
compile: configure
	javac -O -deprecation -target 1.1 com/jcraft/jogg/*.java
	javac -O -deprecation -target 1.1 com/jcraft/jorbis/*.java
	javac -O -deprecation -target 1.1 com/fluendo/codecs/*.java
	javac -O -deprecation -target 1.1 com/fluendo/examples/*.java
	javac -O -deprecation -target 1.1 com/fluendo/jst/*.java
	javac -O -deprecation -target 1.1 com/fluendo/player/*.java
	javac -O -deprecation -target 1.1 com/fluendo/utils/*.java
	javac -O -deprecation -target 1.1 com/fluendo/jheora/*.java
	javac -O -deprecation -target 1.1 com/fluendo/plugin/*.java
